...
class CameraScreenSingle extends StatefulWidget {
  const CameraScreenSingle({super.key});

  @override
  State<CameraScreenSingle> createState() =>
      _CameraScreenSingleState();
}

class _CameraScreenSingleState extends State<CameraScreenSingle> {
